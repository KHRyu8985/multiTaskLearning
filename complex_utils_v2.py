...
Taken from https://github.com/ad12/dl-ss-recon/blob/augment/ss_recon/utils/complex_utils.py
"""
import numpy as np
import torch
import warnings
...
def supports_cplx_tensor() -> bool:
    ...
    # this library uses 2 channel representation for complex numbers
    return False